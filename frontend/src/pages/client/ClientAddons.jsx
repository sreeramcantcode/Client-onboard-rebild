...
import { PageHeader, Loader, EmptyState, PrimaryButton, Pill, Modal, Textarea } from "@/components/Primitives";
...
export default function ClientAddons() {
    ...
    const load = async () => {
        const [a, r] = await Promise.all([api.get("/addons"), api.get("/client/addons/requests")]);
        setAddons(a.data || []);
        setRequests(r.data || []);
    };
