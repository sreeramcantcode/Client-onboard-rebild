...
import { PageHeader, Loader, EmptyState, Pill, PrimaryButton, Modal, Input, Textarea, Select } from "@/components/Primitives";
                                    ...
                                    {(open.messages || []).map((m) => {
                                        ...
                                        return (
                                            <div key={m.id} className={`flex ${mine ? "justify-end" : ""}`}>
                                                ...
                                                >
                                                    <div className={`text-[10px] uppercase tracking-wider mb-1 ${mine ? "text-zinc-400" : "text-zinc-500"}`}>
            ...
            <Modal open={creating} onClose={() => setCreating(false)} title="Open a new ticket">
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <Select value={form.priority} onChange={(e) => setForm({ ...form, priority: e.target.value })} data-testid="ticket-priority">
                    ...
                    <PrimaryButton onClick={createTicket} disabled={!form.subject || !form.message} data-testid="create-ticket-submit">
