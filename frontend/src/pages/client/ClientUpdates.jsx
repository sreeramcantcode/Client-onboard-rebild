...
export default function ClientUpdates({ filterCategory }) {
    const [updates, setUpdates] = useState(null);

    useEffect(() => {
        api.get("/client/updates").then((r) => setUpdates(r.data || []));
    }, []);
        ...
        <div className="p-6 md:p-10">
            ...
            {filtered.length === 0 ? (
                <EmptyState
                    ...
                    description={isReports ? "Reports will appear here once we publish them." : "When the team shares an update, it'll appear here."}
                />
            ) : (
